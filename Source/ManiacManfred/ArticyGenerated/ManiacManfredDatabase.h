...
public:
	...
	UFUNCTION(BlueprintPure, Category = "articy:draft", meta=(keywords="global variables"))
	UManiacManfredGlobalVariables* GetRuntimeGVs(UArticyAlternativeGlobalVariables* Asset) const override
	{
		return static_cast<UManiacManfredGlobalVariables*>(Super::GetRuntimeGVs(Asset));
	}
};
